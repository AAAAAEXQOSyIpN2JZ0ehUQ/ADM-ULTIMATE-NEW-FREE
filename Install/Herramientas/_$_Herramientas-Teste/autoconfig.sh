...
remove_fun () {
msg -ama " Parando SSL Python Payload"
msg -bar
...
clear
msg -bar
msg -azu " Instalador SSL Python Payload"
msg -bar
msg -ama " Script de configuracao automatica"
msg -ama " Requer a porta livre: 80 - 443"
msg -bar
echo -ne " Deseja Prosseguir? [S/N]: "; read x
[[ $x = @(n|N) ]] && msg -bar && return
msg -bar
echo -e "\033[1;36m Instalando SSL Stunnel"
fun_bar 'inst_ssl'
echo -e "\033[1;36m Instalando Socks Python"
fun_bar 'inst_py'
rm -rf proxy.py
...
msg -bar
msg -ama " \033[1;33mSSL Stunnel Porta: \033[1;31m443"
msg -ama " \033[1;33mSocks Python Porta: \033[1;31m80"
msg -bar
sleep 0.5s
